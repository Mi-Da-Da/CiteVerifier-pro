...
function MorePage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-black text-white flex flex-col">
      <SiteBackdrop />
      <SiteNav />
      <main className="relative z-10 flex min-h-[calc(100vh-88px)] -translate-y-12 md:-translate-y-16 flex-col justify-center px-4 sm:px-6 md:px-12 py-12 md:py-16 max-w-6xl mx-auto w-full">
